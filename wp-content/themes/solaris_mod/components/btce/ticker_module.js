angular
    .module('BTCETicker', ['ngAnimate'])
    .factory('BTCESocket', function($rootScope) {
        var socket = io.connect('http://node1.cointechs.com:7333');
    ...
    .controller('BTCETickerCtrl', ['$scope', 'BTCESocket',
        function($scope, BTCESocket) {

            // Declare scope variables defaults
            $scope.exchangeName = 'BTC-e';
            ...
            BTCESocket.on('tickerData', function(data) {
    ...
    .directive('btceTickerComponent', function() {
        return {
            restrict: 'A',
