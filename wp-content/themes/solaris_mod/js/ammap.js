...
AmCharts.wrappedText = function(a, b, c, d, f, e, g, h, k) {
	...
	if (l) {
		...
		if (n.width > h) {
			l.remove();
			for (var l = [], q = 0; - 1 < (index = b.indexOf(" ", q));) l.push(index), q = index + 1;
			for (var p = Math.round(b.length / 2), A = 1E3, y, q = 0; q < l.length; q++) {
				var s = Math.abs(l[q] - p);
				s < A && (y = l[q], A = s)
			}
			if (isNaN(y)) {
				h = Math.ceil(n.width / h);
				for (q = 1; q < h; q++) y = Math.round(b.length / h * q), b = b.substr(0, y) + m + b.substr(y);
				return AmCharts.text(a, b, c, d, f, e,
					g)
			}
			b = b.substr(0, y) + m + b.substr(y + 1);
...
AmCharts.getURL = function(a, b) {
	...
	if ("_parent" == b && window.parent) window.parent.location.href = a;
	else {
		...
		if (AmCharts.ifArray(a)) {
			...
			for (c = 0; c < a.length; c++) {
				...
				var g = this.marginLeft,
					f = AmCharts.text(this.container, d.text, f, this.fontFamily,
						e);
	...
	draw: function() {
		...
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				var z = this.minWidth,
					v = "";
				isNaN(z) || (v = "min-width:" + (z - 2 * A) +
					"px; ");
				m.innerHTML = '<div style="text-align:' + this.textAlign + "; " + v + "max-width:" + this.maxWidth + "px; font-size:" + w + "px; color:" + this.color + "; font-family:" + u + '">' + this.text + "</div>";
				c.chartDiv.appendChild(m);
				this.textDiv = m;
				w = m.offsetWidth;
				u = m.offsetHeight;
				m.clientHeight && (w = m.clientWidth, u = m.clientHeight);
				u += 2 * y;
				v = w + 2 * A;
				!isNaN(z) && v < z && (v = z);
				window.opera && (u += 2);
				var F = !1,
					w = this.offsetY;
				c.handDrawn && (w += c.handDrawScatter + 2);
				"H" != r ? (z = a - v / 2, b < h + u + 10 && "down" != r ? (F = !0, d && (b += w), w = b + s, this.deltaSignY = -1) :
					(d && (b -= w), w = b - u - s, this.deltaSignY = 1)) : (2 * s > u && (s = u / 2), w = b - u / 2, a < g + (k - g) / 2 ? (z = a + s, this.deltaSignX = -1) : (z = a - v - s, this.deltaSignX = 1));
				w + u >= l && (w = l - u);
				w < h && (w = h);
				z < g && (z = g);
				z + v > k && (z = k - v);
				var h = w + y,
					...
					B = this.bulletSize,
					C;
				0 < x || 0 === s ? (0 < y && (a = AmCharts.rect(f, v, u, n, 0, A + 1, D, y, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), e.push(a)), n = AmCharts.rect(f, v, u, n, this.fillAlpha, A, q, this.borderAlpha, this.cornerRadius), this.showBullet &&
					(C = AmCharts.circle(f, B, p, this.fillAlpha), e.push(C))) : (p = [], x = [], "H" != r ? (g = a - z, g > v - s && (g = v - s), g < s && (g = s), p = [0, g - s, a - z, g + s, v, v, 0, 0], x = F ? [0, 0, b - w, 0, 0, u, u, 0] : [u, u, b - w, u, u, 0, 0, u]) : (p = b - w, p > u - s && (p = u - s), p < s && (p = s), x = [0, p - s, b - w, p + s, u, u, 0, 0], p = a < g + (k - g) / 2 ? [0, 0, z < a ? 0 : a - z, 0, 0, v, v, 0] : [v, v, z + v > a ? v : a - z, v, v, 0, 0, v]), 0 < y && (a = AmCharts.polygon(f, p, x, n, 0, A, D, y), a.translate(1, 1), e.push(a)), n = AmCharts.polygon(f, p, x, n, this.fillAlpha, A, q, this.borderAlpha));
				this.bg = n;
				e.push(n);
				n.toFront();
				f = 1 * this.deltaSignX;
				...
				this.bottom = w + u + 1;
				this.yPos = n.y + w;
				C && C.translate(this.pointToX - z + f, b - w);
				b = this.animationDuration;
				0 < this.animationDuration && !d && !isNaN(this.prevX) && (e.translate(this.prevX, this.prevY), e.animate({
					translate: z - f + "," + w
				}, b, "easeOutSine"), m && (t.left = this.prevTX + "px", t.top = this.prevTY + "px", this.xAnim = c.animate({
					node: m
			...
			if (a != this.previousX || b != this.previousY)
				if (this.previousX = a, this.previousY = b, 0 === this.cornerRadius) this.draw();
					...
					if (c) {
						...
						b.left = a + this.horizontalPadding +
							"px";
...
AmCharts.handDrawnLine = function(a, b, c, d, f, e, g, h, k, l, m) {
	...
	for (m = 1; m < b.length; m++)
		for (var q = [b[m - 1], b[m]], p = [c[m - 1], c[m]], p = AmCharts.makeHD(q, p, a.handDrawScatter), q = p[0], p = p[1], A = 1; A < q.length; A++) n.push(AmCharts.line(a, [q[A - 1], q[A]], [p[A - 1], p[A]], d, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
	return n
};
...
AmCharts.wedge = function(a, b, c, d, f, e, g, h, k, l, m, n) {
	...
	var s = 1 / 180 * Math.PI,
		...
		x = b + Math.sin(d * s) * e,
		u = c - Math.cos(d * s) * g,
		w = b + Math.sin((d + f) * s) * e,
		t = c - Math.cos((d + f) * s) * g,
		z = b + Math.sin((d + f) * s) * h,
		s = c - Math.cos((d + f) * s) * p,
		v = {
	...
	d = a.set();
	var D;
	A && (y = q(10 * y), x = q(10 * x), w = q(10 * w), z = q(10 * z), r = q(10 * r), u = q(10 * u), t = q(10 * t), s = q(10 * s), b = q(10 * b), k = q(10 * k), c = q(10 * c), e *= 10, g *= 10, h *= 10, p *= 10, 1 > Math.abs(f) && 1 >= Math.abs(w - x) && 1 >= Math.abs(t - u) && (D = !0));
	f = "";
	var B;
	n && (v["fill-opacity"] = 0, v["stroke-opacity"] = l["stroke-opacity"] / 2, v.stroke = l.stroke);
	0 < k && (A ? (B = " M" + y + "," + (r + k) + " L" + x + "," + (u + k), D || (B += " A" + (b - e) + "," + (k + c - g) + "," + (b + e) + "," + (k + c + g) + "," + x + "," + (u + k) + "," + w + "," + (t + k)), B += " L" + z + "," + (s + k), 0 < h && (D || (B += " B" + (b - h) + "," + (k + c - p) + "," + (b + h) + "," + (k + c + p) +
	...
	A ? (D || (f = " A" + q(b - e) + "," + q(c - g) + "," + q(b + e) + "," + q(c + g) + "," + q(x) + "," + q(u) + "," + q(w) + "," + q(t)), e = " M" + q(y) + "," + q(r) + " L" + q(x) + "," + q(u) + f + " L" + q(z) + "," + q(s)) : e = " M" + y + "," + r + " L" + x + "," + u + (" A" + e + "," + g + ",0," + F + ",1," + w + "," + t) + " L" + z + "," + s;
	0 < h && (A ? D || (e += " B" + (b - h) + "," + (c - p) + "," + (b + h) + "," + (c + p) + "," + z + "," + s + "," + y + "," + r) : e += " A" + h + "," + p + ",0," + F + ",0," + y + "," + r);
	a.handDrawn && (b = AmCharts.line(a, [y, x], [r, u], l.stroke, l.thickness * Math.random() * a.handDrawThickness, l["stroke-opacity"]), d.push(b));
	a = a.path(e + " Z", void 0,
...
AmCharts.AmLegend = AmCharts.Class({
	...
	arrangeEntries: function() {
		...
		for (x = 0; x < s.length; x++) {
			var z = s[x];
			this.reversedOrder && (z = s[s.length - x - 1]);
			r = z.getBBox();
			var v;
			this.equalWidths ? v = e + w * (q + m + this.markerLabelGap) : (v = t, t = t + r.width + e + m);
			v + r.width > n && 0 < x && 0 !== w && (u++, w = 0, v = e, t = v + r.width + e + m);
			z.translate(v, (p + l) * u);
			w++;
			!isNaN(k) && w >= k && (w = 0, u++);
			A.push(z)
		...
		r = A.getBBox();
		k = r.height + 2 * l - 1;
		"left" == a || "right" == a ? (h = r.width + 2 * e, g.style.width = h + b + c + "px") : h = h - b - c - 1;
		...
		c.toBack();
		b = e;
		if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = e + (h - r.width) / 2 : "right" == this.align && (b = e + h - r.width);
		A.translate(b, l + 1);
	...
	createEntry: function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			if (this.useGraphSettings)
				if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, e = a.bulletBorderColorR), n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden ||
					(d = a.bulletColorR), n = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, e, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2), g.push(n)), q = 0, m = l, n = l / 3;
				else {
					var p;
					a.getGradRotation && (p = a.getGradRotation());
					m = a.fillColorsR;
					!0 === a.hidden && (m = d);
					if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, p, g)) q = l, g.translate(q, l / 2);
					m = l
			...
			(e = this.switchType) && "none" != e && ("x" == e ? (p = this.createX(), p.translate(l / 2, l / 2)) : p = this.createV(), p.dItem = a, !0 !== a.hidden ? "x" == e ? p.hide() : p.show() : "x" != e && p.hide(), this.switchable || p.hide(), this.addListeners(p, a), a.legendSwitch = p, k.push(p));
			e = this.color;
			...
			p = this.fontSize;
			g && l <= p && g.translate(q, l / 2 + this.ly - p / 2 + (p + 2 - l) / 2 - n);
			var A;
			d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, A = AmCharts.text(this.container, d, e, b.fontFamily, p, "start"), A.translate(this.lx + m, this.ly), k.push(A), b = A.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
...
AmCharts.AmMap = AmCharts.Class({
	...
	initChart: function() {
		...
		if (this.sizeChanged &&
			AmCharts.hasSVG && this.chartCreated) {
			...
			"ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, clearInterval(this.interval))
	},
	invalidateSize: function() {
	...
	handleWheelReal: function(a) {
		if (!this.wheelBusy) {
			...
			var b = this.zoomLevel(),
				...
				d = c.zoomFactor;
			this.wheelBusy = !0;
			a = AmCharts.fitToBounds(0 < a ? b * d : b / d, c.minZoomLevel,
				c.maxZoomLevel);
	...
	updateSize: function() {
		...
		a.frame <= b ? (a.frame++, b = AmCharts.easeOutSine(0, a.frame, 0, 1, b), 1 <= b ? (b = 1, a.preventHover = !1, a.wheelBusy = !1) : setTimeout(function() {
			a.updateSize.call(a)
		}, AmCharts.updateRate), 0.8 < b && (a.preventHover = !1)) : (b = 1, a.preventHover = !1, a.wheelBusy = !1);
		a.tweenPercent = b;
	...
	handleMouseDown: function(a) {
		AmCharts.resetMouseOver();
		this.mouseIsOver = !0;
		if (this.chartCreated && !this.preventHover && (this.dragMap && (this.stopAnimation(), this.isDragging = !0, this.mapContainerClickX = this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y, this.panEventsEnabled || a && a.preventDefault && a.preventDefault()), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
			var b =
				this.mouseX,
				c = this.mouseY,
				d = a.touches.item(1);
	...
	handleReleaseOutside: function() {
		if (AmCharts.isModern && !this.preventHover) {
			this.stopDrag();
			this.zoomControl && this.zoomControl.draggerUp();
	...
	handleMouseMove: function(a) {
		...
		if (a && a.touches) {
			...
			h && (b.mouse2X = h.pageX - AmCharts.findPosX(b.div),
				b.mouse2Y = h.pageY - AmCharts.findPosY(b.div))
		}
		...
		if (!isNaN(k)) {
			...
			var k = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - e, 2)),
				m = b.previousDistance,
				l = Math.max(b.realWidth, b.realHeight);
			5 > Math.abs(m - k) && (b.isDragging = !0);
			if (!isNaN(m)) {
				var n = 5 * Math.abs(m - k) / l,
					l = h.scale,
					l = AmCharts.fitToBounds(m < k ? l + l * n : l - l * n, g.minZoomLevel, g.maxZoomLevel),
					g = b.zoomLevel(),
					q = b.middleXP,
					m = b.middleYP,
					n = b.realHeight / b.mapHeight,
					p = b.realWidth / b.mapWidth,
					q = (b.zoomX() - q * p) * (l / g) + q * p,
					m = (b.zoomY() - m * n) * (l / g) + m * n;
				0.1 < Math.abs(l - g) && (b.zoomTo(l, q, m, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
			}
			b.previousDistance = k
		}
		b.isDragging && (b.hideBalloon(), b.positionChanged(), h.translate(h.x + (f - c), h.y + (e - d), h.scale), b.updateSmallMap(), a && a.preventDefault && a.preventDefault());
		b.previuosMouseX = f;
		b.previuosMouseY = e
	},
	selectObject: function(a) {
		...
		} else b.returnInitialColorReal(a); if (f = a.groupId)
			for (c =
				b.getGroupById(f), l = 0; l < c.length; l++)
	...
	zoomToRectangle: function(a, b, c, d) {
		var f = this.realWidth,
			...
			g = this.mapSet.scale,
			h = this.zoomControl,
			f = AmCharts.fitToBounds(c / f > d / e ? 0.8 * f / (c * g) : 0.8 * e / (d * g), h.minZoomLevel, h.maxZoomLevel);
	...
	zoomToLatLongRectangle: function(a, b, c, d) {
		var f = this.dataProvider,
			...
			e = AmCharts.fitToBounds(g / k > h / f ? 0.8 * k / g : 0.8 * f / h, e.minZoomLevel,
				e.maxZoomLevel);
	...
	zoomToObject: function(a) {
		...
		"MapImage" ==
			a.objectType && isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && !isNaN(a.latitude) && !isNaN(a.longitude) && this.zoomToLongLat(a.zoomLevel, a.longitude, a.latitude);
		"MapArea" == a.objectType && (e = a.displayObject.getBBox(), b = this.mapScale, c = e.x * b, d = e.y * b, f = e.width * b, e = e.height * b, h = a.autoZoomReal && isNaN(a.zoomLevel) ? f / h > e / k ? 0.8 * h / f : 0.8 * k / e : a.zoomLevel, k = this.zoomControl, h = AmCharts.fitToBounds(h, k.minZoomLevel, k.maxZoomLevel), isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) &&
			isNaN(a.zoomLongitude) && (a = this.mapSet.getBBox(), this.zoomToMapXY(h, -a.x * b + c + f / 2, -a.y * b + d + e / 2)))
	},
	...
	showAsRolledOver: function(a) {
		...
		if (!a.showAsSelected && b && !a.isOver) {
			...
			(c = a.imageLabel) && !a.labelInactive &&
			...
			if ("MapArea" == a.objectType) {
				...
				(c =
					c.rollOverPattern) && b.pattern(c, this.mapScale)
			}
	...
	rollOverMapObject: function(a, b, c) {
		if (this.chartCreated) {
			...
			d && d != a ? (!1 === this.checkIfSelected(d) && (this.returnInitialColor(d, !0), this.previouslyHovered =
				null), this.hideBalloon()) : clearTimeout(this.hoverInt);
			if (!this.preventHover) {
				...
				} else(d = a.displayObject) && (this.allowClickOnSelectedObject ? d.setAttr("cursor", "pointer") : d.setAttr("cursor", "default")); if (this.showDescriptionOnHover) this.showDescription(a);
				else if ((this.showBalloonOnSelectedObject || !this.checkIfSelected(a)) && !1 !== b && (f = this.balloon,
					b = a.colorReal, d = "", void 0 !== b && this.useObjectColorForBalloon || (b = f.fillColor), (f = a.balloonTextReal) && (d = this.formatString(f, a)), this.balloonLabelFunction && (d = this.balloonLabelFunction(a, this)), d && "" !== d)) {
					var e, g;
	...
	coordinateToLatitude: function(a) {
		...
		if (this.mapSet) {
			var c = this.dataProvider,
				...
				f = c.topLatitude;
			b = this.mapHeight;
			"mercator" == c.projection ? (c = this.mercatorLatitudeToCoordinate(d), f = this.mercatorLatitudeToCoordinate(f), a = 2 * Math.atan(Math.exp(2 * (a * (c - f) / b + f) * Math.PI / 180)) - 0.5 * Math.PI, b = AmCharts.radiansToDegrees(a)) : b = a / b * (d - f) + f
		}
		return Math.round(1E6 * b) /
			1E6
	},
		...
		if (c) {
			...
			for (f = 0; f < h; f++) {
				...
				if (1 == e.nodeType) {
					...
					void 0 !== a[b][k].length ?
						this.parseXMLNode(a[b][k], a[b][k].length - 1, e, d + "  ") : this.parseXMLNode(a[b], k, e, d + "  ")
				}
			}
			e = 0;
			c = "";
	...
	getDevInfo: function() {
		var a = this.zoomLevel(),
			a = {
				...
				percentBottom: Math.round((this.realHeight - this.mouseY) / this.realHeight *
					100) + "%"
	...
	getXY: function(a, b, c) {
		void 0 !==
			a && (-1 != String(a).indexOf("%") ? (a = Number(a.split("%").join("")), c && (a = 100 - a), a = Number(a) * b / 100) : c && (a = b - a));
		return a
	},
	...
	getObject: function(a, b) {
		if (b) {
			...
			for (c = 0; c < b.length; c++) {
				...
				if (d =
					this.getObject(a, d.lines)) return d
			}
		}
	},
	parseData: function() {
...
AmCharts.ZoomControl = AmCharts.Class({
	...
	init: function(a, b) {
		...
		if (c.zoomControlEnabled) {
			...
			c.set = d;
			c.zoomSet = r;
			var x = AmCharts.rect(b, f + 6, q + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4);
			x.translate(-3, -3);
			x.mouseup(function() {
				c.handleBgUp()
			});
			r.push(x);
			x = new AmCharts.SimpleButton;
			x.setIcon(a.pathToImages + "plus.gif", c.iconSize);
			x.setClickHandler(a.zoomIn, a);
			x.init(b, f, f, e, g, h, k, l, m, n, s);
			r.push(x.set);
			x = new AmCharts.SimpleButton;
			x.setIcon(a.pathToImages +
				"minus.gif", c.iconSize);
			x.setClickHandler(a.zoomOut, a);
			x.init(b, f, f, e, g, h, k, l, m, n, s);
			x.set.translate(0, q + f);
			r.push(x.set);
			var u = Math.log(y / A) / Math.log(p) + 1,
				x = q / u,
				w;
			for (w = 1; w < u; w++) {
				var t = f + w * x,
					t = AmCharts.line(b, [1, f - 2], [t, t], c.gridColor, c.gridAlpha, 1);
				r.push(t)
			}
			u = new AmCharts.SimpleButton;
			u.setDownHandler(c.draggerDown, c);
			u.setClickHandler(c.draggerUp, c);
			u.init(b, f, x, e, g, h, k, l, m, n);
			r.push(u.set);
			c.dragger = u.set;
			c.previousY = NaN;
			q -= x;
			A = Math.log(A / 100) / Math.log(p);
			p = Math.log(y / 100) / Math.log(p);
			c.realStepSize =
				q / (p - A);
			c.realGridHeight = q;
			c.stepMax = p
	...
	update: function() {
		var a, b = this.zoomFactor,
			...
			e = this.buttonSize,
			g = this.chart;
		this.isDragging ? (g.stopDrag(), a = f.y + (g.mouseY - this.previousY), a = AmCharts.fitToBounds(a, e, this.realGridHeight + e), c = 100 * Math.pow(b,
...
AmCharts.AreasProcessor = AmCharts.Class({
	...
	process: function(a) {
		...
		for (f = 0; f < d; f++) {
			...
			if (g && g.className) {
				...
				m && (c = m, c = AmCharts.processObject(c, AmCharts.AreasSettings, b.theme))
			}
			var n = c.color,
				q = c.alpha,
			...
			void 0 == t && (t = y);
			(y = e.balloonText) || (y = u);
			void 0 == c.colorSolid || isNaN(e.value) || (u = Math.floor((e.value - l) / ((k - l) / b.colorSteps)), u == b.colorSteps && u--, colorPercent = 1 / (b.colorSteps - 1) * u, e.colorReal = AmCharts.getColorFade(m, c.colorSolid, colorPercent));
			...
			if (g && (c = g.area, (g = g.title) && !e.title && (e.title = g), c)) {
				...
				c.setAttr("fill", F);
				c.setAttr("stroke", n);
				c.setAttr("stroke-opacity", r);
				c.setAttr("stroke-width", x);
	...
	updateAllAreas: function() {
		var a = this.chart,
			...
			l = {}, m;
		for (m = 0; m <
			k.length; m++) l[k[m].id] = k[m];
		for (m = 0; m < g.length; m++)
			if (k = g[m], void 0 != c && k.setAttr("fill", c), isNaN(d) || k.setAttr("fill-opacity", d), void 0 != f && k.setAttr("stroke", f), isNaN(e) || k.setAttr("stroke-opacity", e), k.setAttr("stroke-width", b.outlineThickness), h.getAreasFromMap && !l[k.id]) {
...
AmCharts.ImagesProcessor = AmCharts.Class({
	...
	createImage: function(a, b) {
		...
		isNaN(q) && (q = A);
		(A = a.labelPosition) || (A = s);
		s =
			a.labelColor;
		void 0 == s && (s = r);
		r = a.labelRollOverColor;
		void 0 == r && (r = u);
		...
		var v;
		u || w || p || (w = "circle", r = 1, k = h = 0);
		s = y = 0;
		x = a.selectedColorReal;
		if (w) {
			isNaN(r) && (r = 10);
			isNaN(l) && (l = 10);
			"kilometers" == a.widthAndHeightUnits && (r = c.kilometersToPixels(a.width), l = c.kilometersToPixels(a.height));
			"miles" == a.widthAndHeightUnits && (r = c.milesToPixels(a.width), l = c.milesToPixels(a.height));
			if ("circle" == w || "bubble" == w) l = r;
			v = this.createPredefinedImage(z, n, q, w, r, l);
			s = y = 0;
			a.centeredReal ? (isNaN(a.right) || (y = r * g), isNaN(a.bottom) || (s = l * g)) : (y = r * g / 2, s = l * g / 2);
			v.translate(y, s, g)
		} else u ? (isNaN(r) && (r = 10), isNaN(l) && (l = 10), v = d.image(u, 0, 0, r, l), v.node.setAttribute("preserveAspectRatio", "none"), v.setAttr("opacity", h), a.centeredReal && (y = isNaN(a.right) ? -r / 2 : r / 2, s = isNaN(a.bottom) ? -l / 2 : l / 2, v.translate(y, s))) : p && (v = d.path(p), n = v.getBBox(), a.centeredReal ? (y = -n.x * g - n.width * g / 2, isNaN(a.right) || (y = -y), s = -n.y *
			g - n.height * g / 2, isNaN(a.bottom) || (s = -s)) : y = s = 0, v.translate(y, s, g), v.x = y, v.y = s);
		v && (t.push(v), a.image = v, v.setAttr("stroke-opacity", k), v.setAttr("fill-opacity", h), v.setAttr("fill", z));
		!a.showAsSelected && c.selectedObject != a || void 0 == x || v.setAttr("fill", x);
		z = null;
		void 0 !== a.label && (z = AmCharts.text(d, a.label, a.labelColorReal, c.fontFamily, a.labelFontSizeReal, a.labelAlign), h = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) && 0 < h && (v = z.getBBox(), d = AmCharts.rect(d, v.width + 16, v.height + 10, k, h), d.translate(-3, -v.height / 2 - 5), t.push(d)), a.imageLabel = z, !a.labelInactive && a.mouseEnabled && c.addObjectEventListeners(z, a), t.push(z));
	...
	updateSizeAndPosition: function(a) {
		...
		isNaN(a.bottom) || (f = b.getY(a.bottom, !0) - e.height *
			a.scale);
		var g = a.longitude,
			h = a.latitude,
	...
	process: function(a) {
		...
		for (w = 0; w < b.length; w++) {
			...
			if (t.remainVisible || c.selectedObject == t.parentObject) {
				...
				var B = t.alpha;
				isNaN(B) && (B = A);
				var C = t.rollOverAlpha;
				isNaN(C) && (C = r);
				isNaN(C) && (C = B);
				var G = t.rollOverColor;
				void 0 == G && (G = y);
				...
				t.alphaReal = B;
				t.colorReal = D;
				t.rollOverColorReal = G;
				t.rollOverAlphaReal = C;
				t.balloonTextReal = P;
				t.selectedColorReal = R;
				t.thicknessReal = v;
				AmCharts.processDescriptionWindow(d, t);
				var C = this.processCoordinates(t.x, c.realWidth),
					G = this.processCoordinates(t.y, c.realHeight),
					M = t.longitudes,
					P = t.latitudes,
					H = M.length,
					N;
				if (0 < H)
					for (C = [], N = 0; N < H; N++) C.push(c.longitudeToCoordinate(M[N]));
				H = P.length;
				if (0 <
					H)
					for (G = [], N = 0; N < H; N++) G.push(c.latitudeToCoordinate(P[N]));
				if (0 < C.length) {
					AmCharts.dx = 0;
					AmCharts.dy = 0;
					M = AmCharts.line(u, C, G, D, 1, v, F, !1, !1, !0);
					F = AmCharts.line(u, C, G, D, 0.001, 3, F, !1, !1, !0);
					AmCharts.dx = 0.5;
					AmCharts.dy = 0.5;
					z.push(M);
					z.push(F);
					...
					if ("none" != I) {
						var E, O, Q;
						if ("end" == I || "both" == I) B = C[C.length - 1], D = G[G.length - 1], 1 < C.length ? (H = C[C.length - 2], E = G[G.length - 2]) : (H = B, E = D), E = 180 * Math.atan((D - E) / (B - H)) / Math.PI, O = B, Q = D, E = 0 > B - H ? E - 90 : E + 90;
						"both" == I && (B = AmCharts.polygon(u, [-J / 2, 0, J /
							2
						], [1.5 * J, 0, 1.5 * J], K, L, 1, K, L), z.push(B), B.translate(O, Q), B.rotate(E), t.fixedSize && f.push(B));
						if ("start" == I || "both" == I) B = C[0], Q = G[0], 1 < C.length ? (D = C[1], O = G[1]) : (D = B, O = Q), E = 180 * Math.atan((Q - O) / (B - D)) / Math.PI, O = B, E = 0 > B - D ? E - 90 : E + 90;
						"middle" == I && (B = C[C.length - 1], D = G[G.length - 1], 1 < C.length ? (H = C[C.length - 2], E = G[G.length - 2]) : (H = B, E = D), O = H + (B - H) / 2, Q = E + (D - E) / 2, E = 180 * Math.atan((D - E) / (B - H)) / Math.PI, E = 0 > B - H ? E - 90 : E + 90);
						B = AmCharts.polygon(u, [-J / 2, 0, J / 2], [1.5 * J, 0, 1.5 * J], K, L, 1, K, L);
						z.push(B);
						B.translate(O, Q);
						B.rotate(E);
					...
					t.fixedSize && M && (this.linesToResize.push({
						line: M,
						thickness: v
					...
					t.lineSvg = M;
					t.showAsSelected && !isNaN(R) && M.setAttr("stroke", R);
					0 < P.length ? e.push(z) : g.push(z)
				}
			}
		}
		a.parentObject && a.remainVisible && this.process(a.parentObject)
...
AmCharts.ValueLegend = AmCharts.Class({
	...
	init: function(a, b) {
		...
		if (this.showAsGradient) c = AmCharts.rect(b, this.width, this.height, [c, d], 1, this.borderThickness, this.borderColor, 1, 0, 0), c.translate(0, g), e.push(c);
			...
			for (k = this.width / f, l = 0; l < f; l++) m = AmCharts.getColorFade(c,
