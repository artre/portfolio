<?php
/*
 * Template Name: legal-movecontent
...
function mapAndContentOnload() {
	if ((templateName !== "legal-countrie-details-page.php") && (windowWidth > 589)) {
...
}   else if ((templateName === "legal-countrie-details-page.php") && (windowWidth > 589)) {
	if (windowWidth > 1189) {
    	legalContentHeight = Math.round($(window).height() * 0.73);
    	legalMapHeight = Math.round($(window).height() * 0.51);
    }	else if ((windowWidth < 1189) && (windowWidth > 889)) {
    	legalContentHeight = Math.round($(window).height() * 0.72);
    	legalMapHeight = Math.round($(window).height() * 0.45);
    }	else if ((windowWidth < 889) && (windowWidth > 589)) {
    	legalContentHeight = Math.round($(window).height() * 0.72);
    	legalMapHeight = Math.round($(window).height() * 0.60);
    }
    $("#legal-move").children("i").fadeToggle(1);
    $("#legal-content").css("height", legalContentHeight);
	$("#mapdiv").css("height", legalMapHeight);
	$("#legal-content").addClass("map-collapsed");
