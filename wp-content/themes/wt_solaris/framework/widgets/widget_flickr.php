<?php
/**
 * Plugin Name: WellThemes: Flickr Widget
 * Plugin URI: http://wellthemes.com
 * Description: This widget allows to display flickr images in sidebar or the footer.
 * Version: 1.0
...
class wellthemes_flickr_widget extends WP_Widget {
	...
	function wellthemes_flickr_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget('wellthemes_flickr_widget', 'WellThemes: Flickr Widget ', $widget_ops);
	}
