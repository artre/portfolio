			...
			<div class="header">	
				<div class="main">
					...
					<div class="theme-info">		
						<h3><?php _e('Solaris Theme', 'wellthemes'); ?></h3>			
						<ul>
							<li class="support">
						...
						<div class="tab_content">
							<div id="general" class="tab_block">
								...
								<div class="fields_wrap">
									...
									<div class="field field-upload">
										...
										<span class="description long updesc"><?php _e('Upload a logo image or specify path. Max width: 390px. Max height: 55px.', 'wellthemes'); ?>
										</span> 
									</div>	
									...
									<h3><?php _e('News Ticker', 'wellthemes'); ?></h3>
									
									<div class="field">
										<label for="wt_options[wt_show_ticker]"><?php _e('Enable News Ticker', 'wellthemes'); ?></label>
										<input id="wt_options[wt_show_ticker]" name="wt_options[wt_show_ticker]" type="checkbox" value="1" <?php isset($options['wt_show_ticker']) ? checked( '1', $options['wt_show_ticker'] ) : checked('0', '1'); ?> />	<span class="description chkdesc"><?php _e( 'Check to enable news ticker.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">
										<label for="wt_options[wt_ticker_title]"><?php _e('Ticker title', 'wellthemes'); ?></label>
										<input id="wt_options[wt_ticker_title]" name="wt_options[wt_ticker_title]" type="text" value="<?php echo esc_attr($options['wt_ticker_title']); ?>" />
										<span class="description"><?php _e( 'Enter ticker title.', 'wellthemes' ); ?></span>
									</div>
									
									<div class="field">									
										<label for="wt_options[wt_ticker_category]"><?php _e('Ticker Category', 'wellthemes'); ?></label>
										<?php $categories = get_categories( array( 'hide_empty' => 1, 'hierarchical' => 0 ) );  ?>
											
												<select id="wt_ticker_category" name="wt_options[wt_ticker_category]" class="styled">
													<option <?php selected( 0 == $options['wt_ticker_category'] ); ?> value="0"><?php _e( '--none--', 'wellthemes' ); ?></option>
														<?php foreach( $categories as $category ) : ?>
															<option <?php selected( $category->term_id == $options['wt_ticker_category'] ); ?> value="<?php echo $category->term_id; ?>"><?php echo $category->cat_name; ?></option>
														<?php endforeach; ?>
												</select>
											
											<span class="description slcdesc long"><?php _e( 'Select the category for ticker. Select <strong>none</strong> to show latest posts.', 'wellthemes' ); ?></span>					
									</div>
								...
								<h2><?php _e('Sidebars', 'wellthemes'); ?></h2>
									<div class="fields_wrap">
										...
										<div class="field">
											...
											<input id="wt_custom_sidebar_add_button"  class="gen_button" type="button" value="Create" />
										</div>
										...
										<h3><?php _e('Single Post Sidebars', 'wellthemes'); ?></h3>
										<div class="field">
											<label><?php _e('Left Sidebar', 'wellthemes'); ?></label>
											<select id="wt_single_post_sidebar_left" name="wt_options[wt_single_post_sidebar_left]" class="styled">
												<option <?php selected( "" == $options['wt_single_post_sidebar_left'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_single_post_sidebar_left'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
											</select>											
											<span class="description slcdesc"><?php _e( 'Select left sidebar for the single post.', 'wellthemes' ); ?></span>
										</div><!-- /field -->
										
										<div class="field">
											<label><?php _e('Right Sidebar', 'wellthemes'); ?></label>
											<select id="wt_single_post_sidebar_right" name="wt_options[wt_single_post_sidebar_right]" class="styled">
												<option <?php selected( "" == $options['wt_single_post_sidebar_right'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_single_post_sidebar_right'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
										...
										<h3><?php _e('Single Page Sidebar', 'wellthemes'); ?></h3>
										
										<div class="field">
											<label><?php _e('Left Sidebar', 'wellthemes'); ?></label>
											<select id="wt_single_page_sidebar_left" name="wt_options[wt_single_page_sidebar_left]" class="styled">
												<option <?php selected( "" == $options['wt_single_page_sidebar_left'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_single_page_sidebar_left'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
											</select>											
											<span class="description slcdesc"><?php _e( 'Select left sidebar for the single page.', 'wellthemes' ); ?></span>
										</div><!-- /field -->
										
										<div class="field">
											<label><?php _e('Right Sidebar', 'wellthemes'); ?></label>
											<select id="wt_single_page_sidebar_right" name="wt_options[wt_single_page_sidebar_right]" class="styled">
												<option <?php selected( "" == $options['wt_single_page_sidebar_right'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_single_page_sidebar_right'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
										...
										<h3><?php _e('Category Sidebars', 'wellthemes'); ?></h3>
										
										<div class="field">
											<label><?php _e('Left Sidebar', 'wellthemes'); ?></label>
											<select id="wt_category_sidebar_left" name="wt_options[wt_category_sidebar_left]" class="styled">
												<option <?php selected( "" == $options['wt_category_sidebar_left'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_category_sidebar_left'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
											</select>											
											<span class="description slcdesc"><?php _e( 'Select left sidebar for the category archives page.', 'wellthemes' ); ?></span>
										</div><!-- /field -->

										<div class="field">
											<label><?php _e('Right Sidebar', 'wellthemes'); ?></label>
											<select id="wt_category_sidebar_right" name="wt_options[wt_category_sidebar_right]" class="styled">
												<option <?php selected( "" == $options['wt_category_sidebar_right'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_category_sidebar_right'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
										...
										<h3><?php _e('Archive Sidebar', 'wellthemes'); ?></h3>
										
										<div class="field">
											<label><?php _e('Left Sidebar', 'wellthemes'); ?></label>
											<select id="wt_archive_sidebar_left" name="wt_options[wt_archive_sidebar_left]" class="styled">
												<option <?php selected( "" == $options['wt_archive_sidebar_left'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_archive_sidebar_left'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
											</select>											
											<span class="description slcdesc"><?php _e( 'Select left sidebar for the archives page.', 'wellthemes' ); ?></span>
										</div><!-- /field -->										
										
										<div class="field">
											<label><?php _e('Right Sidebar', 'wellthemes'); ?></label>
											<select id="wt_archive_sidebar_right" name="wt_options[wt_archive_sidebar_right]" class="styled">
												<option <?php selected( "" == $options['wt_archive_sidebar_right'] ); ?> value=""><?php _e('Default', 'wellthemes'); ?></option>	
												<?php
													if($sidebars){
														foreach ($sidebars as $sidebar){?>
															<option <?php selected( $sidebar == $options['wt_archive_sidebar_right'] ); ?> value="<?php echo $sidebar; ?>"><?php echo $sidebar ?></option>	
															<?php 
														}														
													}
												?>
							...
							<div id="styles" class="tab_block">
								...
								<div class="fields_wrap">
									...
									<div class="field">
										<label><?php _e('Second color', 'wellthemes'); ?></label>
...
function wt_default_options() {
	$options = array(
		...
		'wt_youtube_url' => '',
		'wt_custom_sidebars' => '',		
		'wt_show_top_header' => 0,
		'wt_show_ticker' => 1,	
		'wt_ticker_category' => 0,		
		'wt_ticker_title' => 'Latest',			
		'wt_show_author_info' => 0,		
		'wt_enable_rating' => 1,
		'wt_show_post_nav' => 1,
		'wt_show_post_img' => 1,
		...
		'wt_single_post_sidebar_left' => '',
		'wt_single_page_sidebar_left' => '',		
		'wt_home_sidebar_right' => '',
		'wt_single_post_sidebar_right' => '',
		'wt_single_page_sidebar_right' => '',
		'wt_archive_sidebar_right' => '',	
		'wt_category_sidebar_right' => '',
		'wt_category_sidebar_left' => '',
		'wt_archive_sidebar_left' => '',
		'wt_primary_color' => '',	
		'wt_second_color' => '',	
		'wt_h1_fontsize' => '',
		'wt_h2_fontsize' => '',
...
function wt_validate_options( $input ) {
	...
	if( $submit ) :	
		...
		$input['wt_ticker_title'] = wp_kses_stripslashes($input['wt_ticker_title']);
		...
		if ( ! isset( $input['wt_show_ticker'] ) )
			$input['wt_show_ticker'] = null;
		$input['wt_show_ticker'] = ( $input['wt_show_ticker'] == 1 ? 1 : 0 );		
		...
		if( !in_array( $input['wt_ticker_category'], $cat_ids ) && ( $input['wt_ticker_category'] != 0 ) )
			$input['wt_ticker_category'] = $options['wt_ticker_category'];
