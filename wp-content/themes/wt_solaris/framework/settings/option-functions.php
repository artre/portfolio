...
function wt_custom_styles(){
	...
	if (!empty($wt_primary_color)){
		...
		$wt_custom_style .= "#slider-section .posts ul li .title{\n background-color: ".$wt_primary_color.";\n background-color: rgba(".$wt_primary_color_rgb." ,0.9)\n}\n\n";	
	...
	if (!empty($wt_second_color)){
		...
		$wt_custom_style .= "#feat-ticker .title h4,\n .footer-menu .title h4{ \n    background: ".$wt_second_color." \n}\n\n";
		$wt_custom_style .= "#feat-ticker .title h4:before,\n .footer-menu .title h4:before{ \n    border-left: 20px solid ".$wt_second_color." \n}\n\n";	
	}	
