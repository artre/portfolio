...
function wellthemes_theme_setup() {
	...
	register_nav_menus( array(
		...
		'footer-menu' => __( 'Footer Menu', 'wellthemes' )		
	) );
	...
	add_image_size( 'wt270_320', 270, 320, true );		//slider
	add_image_size( 'wt270_180', 270, 180, true );		//featured categories
	add_image_size( 'wt175_115', 175, 115, true );		//carousel
...
if ( function_exists('register_sidebar') ) {
	...
	register_sidebar( array(
		...
		'id' => 'sidebar-1',
		'description' => __( 'Left sidebar area', 'wellthemes' ),
